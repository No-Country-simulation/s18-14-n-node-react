...
const Contacto = () => {
    ...
    return (
        <div className="w-[1440px] h-[1024px] bg-background flex">
            <div className="w-[571px] h-[470px] mt-[202px] ml-[104px] flex flex-col gap-12">
                <div className="w-[571px] h-[140px] items-start">
                    <h1 className="text-5xl text-head_text leading-[56px] mb-3 text-left font-bold">
                        Ponte en contacto con nosotros
                    </h1>
                    <p className="text-[16px] font-normal w-[579px] h-[72px] text-subtitle_text leading-6 text-left mb-[50px]">
                ...
                <div className='flex w-[441px] h-[70px]'>
                    ...
                    <div className='flex-col ml-6 items-center w-[347px]'>
                        ...
                        <p className='tracking-[0.5px] text-[16px] text-primary_text_color w-[347px] leading-6 mb-[35px]'>123, calle sin nombre, Buenos Aires, Argentina</p>
                    </div>
                </div>
                <div className='flex w-[441px] h-[70px]'>
                    <div className="w-[70px] h-[70px] items-center bg-accent70 rounded-[5px]">
                    ...
                    <div className='flex-col ml-6 items-center w-[347px]'>
                        ...
                        <p className='tracking-[0.5px] text-[16px] text-primary_text_color w-[347px] leading-6 mb-[35px]'>(+54) 11 1231234</p>
                    </div>
                </div>
                <div className='flex w-[441px] h-[70px]'>
                    <div className="w-[70px] h-[70px] items-center bg-accent70 rounded-[5px]">
                    ...
                    <div className='flex-col ml-6 items-center w-[347px]'>
                        ...
                        <p className='tracking-[0.5px] text-[16px] text-primary_text_color w-[347px] leading-6 mb-[35px]'>info@recetas.com</p>
                    </div>
                </div>
            </div>
