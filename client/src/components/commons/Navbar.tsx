...
export const NavBarWeb = ({
  ...
  return (
    <div
      className={
        "bg-[#c5c5c5] pr-[104px] pl-[104px] flex flex-row gap-6 items-center justify-start h-[100px] relative " +
        className
      }
    >
      <div className="shrink-0 w-[291px] h-[95px] static">
        <div className="bg-[#d9d9d9] w-[291px] h-[95px] absolute left-[104px] top-[2.5px]"></div>
        <SeccionNavBar className="!absolute !left-[158px] !top-[29.5px]" nameSection="LOREM IPSUM"></SeccionNavBar>
      </div>
